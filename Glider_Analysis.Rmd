...
#                                 depth_smooth = predict(loess(max_depth~distance_km_r,WA_deep_maxdepths), seq_WA_deep_dist))
# ggplot(WA_deep_maxdepths, aes(y=-max_depth, x=distance_km_r)) +
#   geom_point() +
#   geom_smooth() +
...
ggplot(raster_dens_WA_shallow, aes(distance_km, depth, fill = density)) +
  ...
  theme_DOM() +
  labs(y="Depth (m)", x = "Distance (km)", fill = "Density (kg/m3)") +
  geom_line(dens_cont_WA_shallow, mapping = aes(x=distance_km, y=den_26, fill=NULL), col="red", span = 0.1) +
  geom_line(dens_cont_WA_shallow, mapping = aes(x=distance_km, y=den_26.2, fill=NULL), col="red", span = 0.1) +
  geom_line(dens_cont_WA_shallow, mapping = aes(x=distance_km, y=den_26.4, fill=NULL), col="red", span = 0.1) +
  geom_line(dens_cont_WA_shallow, mapping = aes(x=distance_km, y=den_26.6, fill=NULL), col="red", span = 0.1) +
  geom_line(dens_cont_WA_shallow, mapping = aes(x=distance_km, y=den_26.8, fill=NULL), col="red", span = 0.1) +
  geom_line(dens_cont_WA_shallow, mapping = aes(x=distance_km, y=den_27, fill=NULL), col="red", span = 0.1)
